...
function phplive_wp_sethtml()
{
	...
	var htmlcode = encodeURIComponent( htmlcode.replace( /\+/g, "%plus%" ) ) ;
	...
	{
		if ( htmlcode )
			alert( "Invalid PHP HTML Code format.  Please copy the code exactly as it is displayed from the PHP Live! Setup->HTML Code area." ) ;
		else
